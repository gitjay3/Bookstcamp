...
export const OptionManagement = ({ template }: OptionManagementProps) => {
    ...
    <section className="bg-white rounded-xl p-8 mb-6 shadow-sm">
      ...
      <div className="flex justify-between mb-6">
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm font-medium text-primary hover:bg-gray-50 hover:border-gray-300 transition-all">
